...
/** @type {string} */
const CACHE_VERSION = '1763991662|17275278070';
/** @type {string} */
const CACHE_PREFIX = 'Ruby Royale-sw-cache-';
...
/** @type {string[]} */
const CACHEABLE_FILES = ["index.wasm","index.pck","index.side.wasm","libgodot-solana-sdk.web.template_release.wasm32.nothreads.wasm"];
